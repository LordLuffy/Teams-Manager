...
export default function SetupScreen({ onSaved }: Props) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen fade-in" style={{ background: "var(--bg-primary)" }}>
      <div className="card p-8 fade-in" style={{ width: "100%", maxWidth: 460 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
          ...
          <div>
            <h1 style={{ color: "var(--text-1)", fontSize: 18, fontWeight: 600, margin: 0 }}>Configuration initiale</h1>
            <p style={{ color: "var(--text-3)", fontSize: 12, marginTop: 3 }}>Teams Manager</p>
          </div>
        </div>

        <div style={{ background: "rgba(59,130,246,0.07)", border: "1px solid rgba(59,130,246,0.2)", borderRadius: 8, padding: "12px 14px", marginBottom: 22 }}>
